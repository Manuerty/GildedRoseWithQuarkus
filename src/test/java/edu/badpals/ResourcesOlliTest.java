...
class ResourcesOlliTest {
    ...
    public void test_post_ok() {
        ...
        // rollback BBDD
        TypedQuery<Orden> query = em.createQuery("select orden from Orden orden join orden.User usuaria where usuaria.nombre = 'Hermione'", Orden.class);
